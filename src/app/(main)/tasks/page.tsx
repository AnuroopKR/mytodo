...
export default function AllTasksPage() {
  ...
  if (loading) {
    return (
      <div className="space-y-6 animate-pulse">
        ...
        <div className="h-12 bg-zinc-200 rounded w-full"></div>
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-zinc-900">All Tasks</h1>
        <p className="text-zinc-500 mt-1">View and manage all your tasks across all projects.</p>
      </div>
          ...
          <div className="flex flex-col md:flex-row gap-4 items-center">
            ...
            <div className="flex gap-2 w-full md:w-auto">
              <Select value={statusFilter} onValueChange={(v) => setStatusFilter(v || "all")}>
                <SelectTrigger className="h-9 w-[130px] bg-white border-zinc-200">
